...
g++ -Lcontrib/googletest/build/googlemock -Lcontrib/googletest/build/googletest -o build/conwrap build/Processor.o build/ProcessorAsio.o build/ProcessorQueue.o build/main.o -lpthread -lgmock -lgtest 
